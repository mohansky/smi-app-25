...
export function PaymentsChart({ chartData }: { chartData: ChartDataProps[] }) {
  ...
  return (
    <>
      ...
      <CardFooter>
        <div className="flex w-full justify-between items-center gap-2 text-sm font-firaSans">
          <div className="flex items-center gap-2 leading-none text-chart-2">
          ...
          <div
            className={`flex items-center gap-2 leading-none ${
              difference >= 0 ? "text-chart-3" : "text-chart-1"
            }`}
          >
